...
// at the top of this array. Prefer pdfFile for Writing Team PDFs (files live
// under /public/article-pdfs/, same pattern as /public/policy-briefs/).
// content is for HTML articles rendered via RichTextBody.
