...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with Legislate4Life. We'd love to hear from you about our farmers' mental health advocacy work.",
};
              ...
              <div className="bg-muted rounded-xl p-8 sticky top-24">
                ...
                <div className="mt-6 p-4 bg-primary-50 rounded-lg">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    ...
                    text 988) or the{" "}
                    <strong>Farm Aid Hotline</strong> at 1-800-FARM-AID.
                  </p>
                </div>
              </div>
            </div>
